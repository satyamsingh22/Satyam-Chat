...
const Profile = () => {
  ...
  // Conditionally check for posts or bookmarks based on activeTab
          ...
          <section>
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <Badge className='w-fit' variant='secondary'><AtSign /> <span className='pl-1'>{userProfile?.username || "Username"}</span></Badge>
